...
export default function DashboardUserView() {
  ...
  const user = trpc.userRouter.findById.useQuery({ id: String(params.id) });
                ...
                <div className="sm:col-span-9">
                  <div className="space-y-2">
                    <div className="checkbox-container">
                      ...
                      />
                      <label htmlFor="adminRole" className="ms-2 text-sm">
                        Admin
                      </label>
                    </div>
                    <div className="checkbox-container">
                      ...
                      />
                      <label htmlFor="userRole" className="ms-2 text-sm">
                        User
                      </label>
                    </div>
                    {errors.roles && (
