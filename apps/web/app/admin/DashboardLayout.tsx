    ...
    <Suspense>
      <QueryParamProvider adapter={NextAdapterApp}>
        <div className="dashboard-layout">
          <header className="inset-x-0 top-0 z-[48] flex w-full flex-wrap border-b bg-white py-2.5 text-sm dark:border-gray-700 dark:bg-gray-800 sm:flex-nowrap sm:justify-start sm:py-4 lg:ps-64">
            <nav
              ...
              <div className="ms-auto flex w-full items-center justify-end sm:order-3 sm:justify-between sm:gap-x-3">
                ...
                <div className="flex flex-row items-center justify-end gap-2">
                  ...
                  <div className="hs-dropdown relative inline-flex [--placement:bottom-right]">
                    ...
                    <div
                      className="hs-dropdown-menu duration hs-dropdown-open:opacity-100 hidden min-w-60 rounded-lg bg-white p-2 opacity-0 shadow-md transition-[opacity,margin] dark:border dark:border-gray-700 dark:bg-gray-800"
          ...
          {/* End Sidebar Toggle */}
          {/* Sidebar */}
          <div className="hs-overlay hs-overlay-open:translate-x-0 fixed bottom-0 start-0 top-0 z-[10] hidden w-64 -translate-x-full transform overflow-y-auto border-e border-gray-200 bg-gray-100 bg-gray-100 pb-10 pt-7 transition-all duration-300 dark:border-gray-700 dark:bg-gray-800 lg:bottom-0 lg:end-auto lg:block lg:translate-x-0 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500 [&::-webkit-scrollbar-track]:bg-gray-100 dark:[&::-webkit-scrollbar-track]:bg-slate-700 [&::-webkit-scrollbar]:w-2">
            <div className="px-6">
              <Link
          ...
          {/* End Sidebar */}
          {/* Content */}
          <div className="w-full px-4 pb-16 pt-10 sm:px-6 md:px-8 lg:ps-72">
            {children}
          </div>
          {/* End Content */}
          {/* ========== END MAIN CONTENT ========== */}
