...
export const RequestMagicLoginLinkDto = z.object({
  email: z.string().email(),
});
export type RequestMagicLoginLinkDtoType = z.infer<
  typeof RequestMagicLoginLinkDto
>;

export const QuickLoginDto = z.object({
  id: z.string().uuid(),
});
export type QuickLoginDtoType = z.infer<typeof QuickLoginDto>;
